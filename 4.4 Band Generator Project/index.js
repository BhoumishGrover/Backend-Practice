...
app.post("/submit", (req, res) => {
  ...
  var iAdj = Math.floor(Math.random()* adj.length);
  var iNoun = Math.floor(Math.random()* noun.length);

  var name = adj[iAdj] + " " + noun[iNoun];

  res.render(__dirname + "/views/index.ejs",{ generatedName: `<h1> ${name} </h1>` });
});
